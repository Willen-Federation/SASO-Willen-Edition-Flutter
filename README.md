...
- 日本語: <https://saso-willen-flutter.netlify.app/legal/privacy-policy/>
- English: <https://saso-willen-flutter.netlify.app/en/legal/privacy-policy/>

ソースは [`docs/legal/privacy-policy.md`](docs/legal/privacy-policy.md) (JA) / [`docs/legal/privacy-policy.en.md`](docs/legal/privacy-policy.en.md) (EN)。リリース提出手順は [`docs/release.md`](docs/release.md) を参照してください。
Source files: [`docs/legal/privacy-policy.md`](docs/legal/privacy-policy.md) (JA) / [`docs/legal/privacy-policy.en.md`](docs/legal/privacy-policy.en.md) (EN). Submission notes: [`docs/release.md`](docs/release.md).
