...
mixin _$ProblemDetails {
 ...
 String get type; String get title; int get status; String? get detail; String? get instance;// ignore: invalid_annotation_target
@JsonKey(name: 'code') String? get sasoCode;// ignore: invalid_annotation_target
@JsonKey(name: 'traceId') String? get traceId;
...
@useResult
$Res call({
 String type, String title, int status, String? detail, String? instance,@JsonKey(name: 'code') String? sasoCode,@JsonKey(name: 'traceId') String? traceId
});
...
/// Create a copy of ProblemDetails
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? title = null,Object? status = null,Object? detail = freezed,Object? instance = freezed,Object? sasoCode = freezed,Object? traceId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  String title,  int status,  String? detail,  String? instance, @JsonKey(name: 'code')  String? sasoCode, @JsonKey(name: 'traceId')  String? traceId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProblemDetails() when $default != null:
return $default(_that.type,_that.title,_that.status,_that.detail,_that.instance,_that.sasoCode,_that.traceId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  String title,  int status,  String? detail,  String? instance, @JsonKey(name: 'code')  String? sasoCode, @JsonKey(name: 'traceId')  String? traceId)  $default,) {final _that = this;
switch (_that) {
case _ProblemDetails():
return $default(_that.type,_that.title,_that.status,_that.detail,_that.instance,_that.sasoCode,_that.traceId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  String title,  int status,  String? detail,  String? instance, @JsonKey(name: 'code')  String? sasoCode, @JsonKey(name: 'traceId')  String? traceId)?  $default,) {final _that = this;
switch (_that) {
case _ProblemDetails() when $default != null:
return $default(_that.type,_that.title,_that.status,_that.detail,_that.instance,_that.sasoCode,_that.traceId);case _:
  return null;
...
class _ProblemDetails extends ProblemDetails {
  const _ProblemDetails({required this.type, required this.title, required this.status, this.detail, this.instance, @JsonKey(name: 'code') this.sasoCode, @JsonKey(name: 'traceId') this.traceId}): super._();
...
@override@JsonKey(name: 'code') final  String? sasoCode;
// ignore: invalid_annotation_target
@override@JsonKey(name: 'traceId') final  String? traceId;
...
/// Create a copy of ProblemDetails
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? title = null,Object? status = null,Object? detail = freezed,Object? instance = freezed,Object? sasoCode = freezed,Object? traceId = freezed,}) {
