...
mixin _$ServerConfig {
 ...
 String get baseUrl; ApiMode get apiMode; String? get sessionCookie; String? get jwtToken;
...
@override
int get hashCode => Object.hash(runtimeType,baseUrl,apiMode,sessionCookie,jwtToken);

@override
String toString() {
  return 'ServerConfig(baseUrl: $baseUrl, apiMode: $apiMode, sessionCookie: $sessionCookie, jwtToken: $jwtToken)';
}
...
@useResult
$Res call({
 String baseUrl, ApiMode apiMode, String? sessionCookie, String? jwtToken
});
...
/// Create a copy of ServerConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? baseUrl = null,Object? apiMode = null,Object? sessionCookie = freezed,Object? jwtToken = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String baseUrl,  ApiMode apiMode,  String? sessionCookie,  String? jwtToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServerConfig() when $default != null:
return $default(_that.baseUrl,_that.apiMode,_that.sessionCookie,_that.jwtToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String baseUrl,  ApiMode apiMode,  String? sessionCookie,  String? jwtToken)  $default,) {final _that = this;
switch (_that) {
case _ServerConfig():
return $default(_that.baseUrl,_that.apiMode,_that.sessionCookie,_that.jwtToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String baseUrl,  ApiMode apiMode,  String? sessionCookie,  String? jwtToken)?  $default,) {final _that = this;
switch (_that) {
case _ServerConfig() when $default != null:
return $default(_that.baseUrl,_that.apiMode,_that.sessionCookie,_that.jwtToken);case _:
  return null;
...
class _ServerConfig implements ServerConfig {
  const _ServerConfig({this.baseUrl = '', this.apiMode = ApiMode.mock, this.sessionCookie, this.jwtToken});
...
/// Create a copy of ServerConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? baseUrl = null,Object? apiMode = null,Object? sessionCookie = freezed,Object? jwtToken = freezed,}) {
