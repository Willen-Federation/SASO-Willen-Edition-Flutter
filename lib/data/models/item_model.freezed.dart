...
mixin _$ItemModel {
 ...
 String get id; String get name; String? get description; String get categoryId; String? get categoryName; List<FeatureModel> get features; String? get janCode; String? get isbnCode; String? get labelCode; String? get note; int get price; int get stock; String? get storageLocationId; String get registeredAt; String? get updatedAt; String get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,categoryId,categoryName,const DeepCollectionEquality().hash(features),janCode,isbnCode,labelCode,note,price,stock,storageLocationId,registeredAt,updatedAt,status);

@override
String toString() {
  return 'ItemModel(id: $id, name: $name, description: $description, categoryId: $categoryId, categoryName: $categoryName, features: $features, janCode: $janCode, isbnCode: $isbnCode, labelCode: $labelCode, note: $note, price: $price, stock: $stock, storageLocationId: $storageLocationId, registeredAt: $registeredAt, updatedAt: $updatedAt, status: $status)';
}
...
@useResult
$Res call({
 String id, String name, String? description, String categoryId, String? categoryName, List<FeatureModel> features, String? janCode, String? isbnCode, String? labelCode, String? note, int price, int stock, String? storageLocationId, String registeredAt, String? updatedAt, String status
});
...
/// Create a copy of ItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? categoryId = null,Object? categoryName = freezed,Object? features = null,Object? janCode = freezed,Object? isbnCode = freezed,Object? labelCode = freezed,Object? note = freezed,Object? price = null,Object? stock = null,Object? storageLocationId = freezed,Object? registeredAt = null,Object? updatedAt = freezed,Object? status = null,}) {
  return _then(_self.copyWith(
...
as int,storageLocationId: freezed == storageLocationId ? _self.storageLocationId : storageLocationId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? description,  String categoryId,  String? categoryName,  List<FeatureModel> features,  String? janCode,  String? isbnCode,  String? labelCode,  String? note,  int price,  int stock,  String? storageLocationId,  String registeredAt,  String? updatedAt,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ItemModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.categoryId,_that.categoryName,_that.features,_that.janCode,_that.isbnCode,_that.labelCode,_that.note,_that.price,_that.stock,_that.storageLocationId,_that.registeredAt,_that.updatedAt,_that.status);case _:
  return orElse();
...
class _ItemModel extends ItemModel {
  const _ItemModel({required this.id, required this.name, this.description, required this.categoryId, this.categoryName, final  List<FeatureModel> features = const [], this.janCode, this.isbnCode, this.labelCode, this.note, this.price = 0, this.stock = 0, this.storageLocationId, required this.registeredAt, this.updatedAt, this.status = 'active'}): _features = features,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,categoryId,categoryName,const DeepCollectionEquality().hash(_features),janCode,isbnCode,labelCode,note,price,stock,storageLocationId,registeredAt,updatedAt,status);
