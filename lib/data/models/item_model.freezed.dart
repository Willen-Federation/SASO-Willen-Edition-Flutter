...
mixin _$ItemModel {
 ...
 String get id; String get name; String? get description; String get categoryId; String? get categoryName; List<FeatureModel> get features; String get registeredAt; String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,categoryId,categoryName,const DeepCollectionEquality().hash(features),registeredAt,updatedAt);

@override
String toString() {
  return 'ItemModel(id: $id, name: $name, description: $description, categoryId: $categoryId, categoryName: $categoryName, features: $features, registeredAt: $registeredAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, String? description, String categoryId, String? categoryName, List<FeatureModel> features, String registeredAt, String? updatedAt
});
...
/// Create a copy of ItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? categoryId = null,Object? categoryName = freezed,Object? features = null,Object? registeredAt = null,Object? updatedAt = freezed,}) {
  return _then(_self.copyWith(
...
as List<FeatureModel>,registeredAt: null == registeredAt ? _self.registeredAt : registeredAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? description,  String categoryId,  String? categoryName,  List<FeatureModel> features,  String registeredAt,  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ItemModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.categoryId,_that.categoryName,_that.features,_that.registeredAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? description,  String categoryId,  String? categoryName,  List<FeatureModel> features,  String registeredAt,  String? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ItemModel():
return $default(_that.id,_that.name,_that.description,_that.categoryId,_that.categoryName,_that.features,_that.registeredAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? description,  String categoryId,  String? categoryName,  List<FeatureModel> features,  String registeredAt,  String? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ItemModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.categoryId,_that.categoryName,_that.features,_that.registeredAt,_that.updatedAt);case _:
  return null;
...
class _ItemModel extends ItemModel {
  const _ItemModel({required this.id, required this.name, this.description, required this.categoryId, this.categoryName, final  List<FeatureModel> features = const [], required this.registeredAt, this.updatedAt}): _features = features,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,categoryId,categoryName,const DeepCollectionEquality().hash(_features),registeredAt,updatedAt);
...
/// Create a copy of ItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? categoryId = null,Object? categoryName = freezed,Object? features = null,Object? registeredAt = null,Object? updatedAt = freezed,}) {
