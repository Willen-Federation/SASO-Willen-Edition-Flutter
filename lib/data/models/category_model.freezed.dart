...
mixin _$CategoryModel {
 ...
 String get id; String get name; String? get parentId; List<CategoryModel> get children; int get depth;
...
@override
String toString() {
  return 'CategoryModel(id: $id, name: $name, parentId: $parentId, children: $children, depth: $depth)';
}
...
@useResult
$Res call({
 String id, String name, String? parentId, List<CategoryModel> children, int depth
});
...
as List<CategoryModel>,depth: null == depth ? _self.depth : depth // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? parentId,  List<CategoryModel> children,  int depth)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? parentId,  List<CategoryModel> children,  int depth)  $default,) {final _that = this;
switch (_that) {
case _CategoryModel():
return $default(_that.id,_that.name,_that.parentId,_that.children,_that.depth);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? parentId,  List<CategoryModel> children,  int depth)?  $default,) {final _that = this;
switch (_that) {
case _CategoryModel() when $default != null:
return $default(_that.id,_that.name,_that.parentId,_that.children,_that.depth);case _:
  return null;
...
class _CategoryModel extends CategoryModel {
  const _CategoryModel({required this.id, required this.name, this.parentId, final  List<CategoryModel> children = const [], this.depth = 0}): _children = children,super._();
